...
a_valdez = Model.create(first_name: "Aileen", last_name: "Valdez", based: "New Jersey", ethnicity: "Hispanic", feet: 5, inches: 2, work_status: false)
...
dianna_levy = Model.create(first_name: "Dianna", last_name: "Levy", based: "Venzuela", ethnicity: "Hispanic", feet: 5, inches: 4, work_status: false)
emira_com = Model.create(first_name: "Emira", last_name: "Com", based: "Iraq", ethnicity: "Arab", feet: 5, inches: 10, work_status: false)
damila_fig = Model.create(first_name: "Damila", last_name: "Figoroua", based: "Dominican Republic", ethnicity: "Hispanic", feet: 5, inches: 2, work_status: false)
...
adriana_lima = Model.create(first_name: "Eliza", last_name: "Lopez", based: "Miami", ethnicity: "Hispanic", feet: 5, inches: 4, work_status: false)
...
ariany_celeste = Model.create(first_name: "Ariany", last_name: "Celeste", based: "Mexico", ethnicity: "Hispanic", feet: 5, inches: 2, work_status: false)
